...
export default function SettingsScreen() {
  ...
  // Status colors — only allowed palette
  ...
  const stateColor = (st: string) => st==="HEALTHY"?"text-neutral-800":st==="DEGRADED"?"text-[#dc2626]":"text-neutral-400"
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-auto bg-white text-neutral-900">
      ...
      <div className="flex items-start gap-3 px-5 pt-3 pb-3 border-b-2 border-neutral-200 flex-none">
        ...
        {/* Tab bar — single-container toggle */}
      ...
      {/* ══════════════════════════════════════════════════════════════════
          EXISTING TABS — completely unchanged logic
          ══════════════════════════════════════════════════════════════════ */}
